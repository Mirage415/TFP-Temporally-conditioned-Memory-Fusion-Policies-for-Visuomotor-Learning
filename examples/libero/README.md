...
This code bundle does not vendor the LIBERO simulator. Docker builds fetch LIBERO automatically; non-Docker runs should set `LIBERO_ROOT` to a local LIBERO checkout.
...
uv pip sync examples/libero/requirements.txt "${LIBERO_ROOT}/requirements.txt" --extra-index-url https://download.pytorch.org/whl/cu113 --index-strategy=unsafe-best-match
